    ...
    <section class="w-full">
      ...
      <fieldset class="fieldset bg-base-200/50 border-base-300 rounded-box mt-6 border p-4">
        ...
        <label for="posts-section-username" class="label text-wrap break-words">
          ...
          {#if $form.socialNetworks?.some( (x: string) => socialNetworksRequirements.includes(x) )}
            <span class="text-brand-600 italic">{$t(`${RouteTypes.Form}.required`)}</span>
          {/if}
        </label>
        <input
      ...
      <fieldset class="fieldset bg-base-200/50 border-base-300 rounded-box mt-6 border p-4">
        <!-- Blog url -->
        <label for="posts-section-blog-post-url" class="label text-wrap break-words" class:hidden={!$form.socialNetworks?.includes('blog')}>
          {@html $t(`${RouteTypes.Form}.${Forms.MediaCoverage}.form.posts-section.blog-post-url`)}
          {#if $form.socialNetworks?.includes('blog')}
            <span class="text-brand-600 italic">{$t(`${RouteTypes.Form}.required`)}</span>
          {/if}
        </label>
        <input
        ...
        <label for="posts-section-number-of-posts" class="label text-wrap break-words">
          {@html $t(`${RouteTypes.Form}.${Forms.MediaCoverage}.form.posts-section.number-of-posts`)}
        ...
        <label for="posts-section-number-of-clicks" class="label text-wrap break-words">
          {@html $t(`${RouteTypes.Form}.${Forms.MediaCoverage}.form.posts-section.number-of-clicks`)}
        ...
        <label for="posts-section-scope-of-posts" class="label text-wrap break-words">
          {@html $t(`${RouteTypes.Form}.${Forms.MediaCoverage}.form.posts-section.scope-of-posts`)}
          {#if $form.socialNetworks?.some( (x: SocialNetwork) => getValues(SocialNetworks).includes(x) )}
            <span class="text-brand-600 italic">{$t(`${RouteTypes.Form}.required`)}</span>
          {/if}
        </label>
        ...
        <label for="posts-section-interaction-with-posts" class="label text-wrap break-words">
          {@html $t(`${RouteTypes.Form}.${Forms.MediaCoverage}.form.posts-section.interaction-with-posts`)}
          {#if $form.socialNetworks?.some( (x: SocialNetwork) => getValues(SocialNetworks).includes(x) )}
            <span class="text-brand-600 italic">{$t(`${RouteTypes.Form}.required`)}</span>
          {/if}
        </label>
      ...
      <fieldset class="fieldset bg-base-200/50 border-base-300 rounded-box mt-6 border p-4">
        ...
        <label for="stories-section-number-of-stories" class="label text-wrap break-words">
          {@html $t(`${RouteTypes.Form}.${Forms.MediaCoverage}.form.stories-section.number-of-stories`)}
        ...
        <label for="stories-section-average-story-reach" class="label text-wrap break-words">
          {@html $t(`${RouteTypes.Form}.${Forms.MediaCoverage}.form.stories-section.average-story-reach`)}
          {#if $form.socialNetworks?.includes('instagram')}
            <span class="text-brand-600 italic">{$t(`${RouteTypes.Form}.required`)}</span>
          {/if}
        </label>
        ...
        <label for="stories-section-interaction-with-stories" class="label text-wrap break-words">
          {@html $t(`${RouteTypes.Form}.${Forms.MediaCoverage}.form.stories-section.interaction-with-stories`)}
          {#if $form.socialNetworks?.includes('instagram')}
            <span class="text-brand-600 italic">{$t(`${RouteTypes.Form}.required`)}</span>
          {/if}
        </label>
      ...
      <fieldset class="fieldset bg-base-200/50 border-base-300 rounded-box mt-6 border p-4">
        ...
        <label for="remarks" class="label text-wrap break-words">
          {@html $t(
            `${RouteTypes.Form}.${Forms.MediaCoverage}.form.remarks.title`
          )}
        ...
        <p class="information">
          {@html $t(
            `${RouteTypes.Form}.${Forms.MediaCoverage}.form.remarks.paragraph`
          )}
        </p>
        <textarea
          id="remarks"
