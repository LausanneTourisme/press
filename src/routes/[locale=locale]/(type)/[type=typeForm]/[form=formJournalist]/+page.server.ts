...
export const actions = {
    default: async ({ request }) => {
        ...
        const html = generateMailContent(form.data as MediaProfileJournalist)
...
const generateMailContent = (data: MediaProfileJournalist) => {
...
<body>
  ...
  <section>
    ...
    <div class="field"><span class="label">Types :</span> <span>${data.mediaTypes.join(', ')}</span></div>
  </section>
`
  ...
  <section>
    ...
    <div class="field"><span class="label">Réduction sur les transports suisses :</span> <ul>${data.travelInformation.travelReductions?.map(x => `<li>${x}</li>`).join("")}</ul></div>
...
`
  ...
  <section>
    ...
    <div class="field"><span class="label">Titre :</span> <span>${data.personalInformation.title}</span></div>
