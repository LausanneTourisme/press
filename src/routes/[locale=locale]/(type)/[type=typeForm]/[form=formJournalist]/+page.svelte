        ...
        {#if $form.mediaTypes.includes(MediaTypes.Online)}
          ...
          >
            ...
            <label for="online-statistics-montlhy-page-views" class="label text-wrap break-words">
              {@html $t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.statistics.${MediaTypes.Online}.montlhy-page-views`
              )}
    ...
    {#if step === 1}
      <section class="step2 media-coverage">
        <Heading tag="h2" class="mt-6 mb-2 text-2xl md:text-2xl">
          {@html $t(`${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.title`)}
        </Heading>

        {#if $form.mediaTypes.includes(MediaTypes.Print)}
          <Heading tag="h3" class="mt-6 mb-2 text-lg md:text-lg">
            {@html $t(
              `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Print}.title`
            )}
          </Heading>
          <fieldset
          ...
          >
            <label for="print-coverage-total-pages" class="label text-wrap break-words">
              {@html $t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Print}.total-pages`
              )}
            ...
            <label for="print-coverage-article-length" class="label text-wrap break-words">
              {@html $t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Print}.article-length`
              )}
            ...
            <label for="print-coverage-publish-date" class="label text-wrap break-words">
              {@html $t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Print}.publish-date`
              )}
        ...
        {#if ($form.mediaTypes.includes(MediaTypes.Tv) && $form.mediaTypes.includes(MediaTypes.Radio)) || ($form.mediaTypes.includes(MediaTypes.Tv) && !$form.mediaTypes.includes(MediaTypes.Radio)) || ($form.mediaTypes.includes(MediaTypes.Radio) && !$form.mediaTypes.includes(MediaTypes.Tv))}
          <Heading tag="h3" class="mt-6 mb-2 text-lg md:text-lg">
            {@html $t(
              `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Radio}-and-${MediaTypes.Tv}.title`
            )}
          </Heading>
          <fieldset
          ...
          >
            ...
            >
              {@html $t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Radio}-and-${MediaTypes.Tv}.article-thematic`
              )}
            ...
            <input
              ...
              class="input w-full {$errors.mediaCoverageTvOrRadio?.articleThematic
                ...
                : ''}"
              placeholder={$t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Radio}-and-${MediaTypes.Tv}.article-thematic-placeholder`
              )}
            ...
            >
              {@html $t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Online}.publish-date`
              )}
        ...
        {#if $form.mediaTypes.includes(MediaTypes.Online)}
          <Heading tag="h3" class="mt-6 mb-2 text-lg md:text-lg">
            {@html $t(
              `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Online}.title`
            )}
          </Heading>
          <fieldset
          ...
          >
            <label for="online-coverage-article-length" class="label text-wrap break-words">
              {@html $t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Online}.article-length`
              )}
            ...
            <label for="online-coverage-article-thematic" class="label text-wrap break-words">
              {@html $t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Online}.article-thematic`
              )}
            ...
            <input
              ...
              class="input w-full {$errors.mediaCoverageOnline?.articleThematic
                ...
                : ''}"
              placeholder={$t(
                `${RouteTypes.Forms}.${Forms.Journalist}.form.coverages.${MediaTypes.Online}.article-thematic-placeholder`
              )}
