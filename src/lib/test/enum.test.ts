...
describe('get values from enums', () => {
    it('Theme', () => {
        expect(getValues(RouteTypes)).toEqual(['home',
            'articles',
            'contact',
            'coverage',
            'highlights',
    ...
    it('Forms', () => {
        expect(getValues(Forms)).toEqual([
            'journalist',
            'content-creator',
            'media-coverage',
            'thanks'
    ...
    it('MediaTypes', () => {
        expect(getValues(MediaTypes)).toEqual([
            'print',
            'online',
            'tv',
            'radio'
    ...
    it('Titles', () => {
        expect(getValues(Titles)).toEqual([
            'mrs',
            'mr',
            'they'
        ]);
    ...
    it('SocialNetworks', () => {
        expect(getValues(SocialNetworks)).toEqual([
            'instagram',
            'tiktok',
            'youtube',
            'blog'
