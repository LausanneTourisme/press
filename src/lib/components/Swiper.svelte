...
<section class="embla {style}">
  ...
  <div class:hidden={!showButtons}>
    <button
      ...
      class="embla__prev absolute top-[calc(50%_-_48px)] left-1 flex hidden h-16 w-16 items-center justify-center rounded-full bg-red-600/60 text-white transition-[background] hover:bg-red-600"
      onclick={prev}
    >
    ...
    <button
      ...
      class="embla__next absolute top-[calc(50%_-_48px)] right-1 flex hidden h-16 w-16 items-center justify-center rounded-full bg-red-600/60 text-white transition-[background] hover:bg-red-600"
      onclick={next}
    >
